export default abstract class ScoringObject {
   ...
   * @param points scoring system
   * @param image url of the images
   */
  public constructor(canvas: HTMLCanvasElement, points: number, image: string) {
    this.canvas = canvas;
    ...
    this.image = ScoringObject.loadNewImage(image);
    this.points = points;
